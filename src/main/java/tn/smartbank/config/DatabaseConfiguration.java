package tn.smartbank.config;

import tn.smartbank.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("tn.smartbank.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("tn.smartbank.repository.search")
